...
void SceneLight::Init()
{
	...
	camera.Init(Vector3(30, 40, 40), Vector3(0, 0, 0), Vector3(0, 1, 0));
	...
	meshList[GEO_SPHERE] = MeshBuilder::GenerateSphere("sphere", Color(1, 0.4, 0.6), 40, 40, 1);
	//meshList[GEO_SPHERE1] = MeshBuilder::GenerateSphere("sphere", Color(0.6, 0.3, 0.4), 40, 40, 1); //kirby body 1.19 0.61 0.79
	//meshList[GEO_SPHERE2] = MeshBuilder::GenerateSphere("sphere", Color(1, 0, 0), 40, 40, 1);  //red feather
	//meshList[GEO_SPHERE3] = MeshBuilder::GenerateSphere("sphere", Color(1, 0.5, 0), 40, 40, 1); //orange feather
	//meshList[GEO_SPHERE4] = MeshBuilder::GenerateSphere("sphere", Color(1, 0.8, 0), 40, 40, 1); //yellow feather
	//meshList[GEO_SPHERE5] = MeshBuilder::GenerateSphere("sphere", Color(0.2, 0.8, 0.2), 40, 40, 1); //green feather
	//meshList[GEO_SPHERE6] = MeshBuilder::GenerateSphere("sphere", Color(0, 0, 1), 40, 40, 1); //blue feather
	//meshList[GEO_SPHERE7] = MeshBuilder::GenerateSphere("sphere", Color(0.5, 0, 0.5), 40, 40, 1); //purple feather
	//meshList[GEO_SPHERE8] = MeshBuilder::GenerateSphere("sphere", Color(0.9, 0.1, 0.4), 40, 40, 1); //kirby shoes

	meshList[GEO_LIGHTBALL] = MeshBuilder::GenerateSphere("lightball", Color(1, 1, 1), 40, 40, 1);

	/*meshList[GEO_TORUS] = MeshBuilder::GenerateTorus("torus", Color(1, 0, 0), 20, 20, 0.3, 1.1);*/
	...
	/*meshList[GEO_TORUS]->material.kAmbient.Set(0.1f, 0.1f, 0.3f);
	meshList[GEO_TORUS]->material.kDiffuse.Set(0.7f, 0.7f, 0.7f);
	meshList[GEO_TORUS]->material.kSpecular.Set(0.3f, 0.3f, 0.3f);
	meshList[GEO_TORUS]->material.kShininess = 3.f;*/
